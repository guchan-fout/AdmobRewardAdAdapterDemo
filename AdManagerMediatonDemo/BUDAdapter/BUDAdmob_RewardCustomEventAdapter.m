...
- (void)rewardedVideoAdDidLoad:(BURewardedVideoAd *)rewardedVideoAd {
    BUD_Log(@"rewardedVideoAdDidLoad::%s", __func__);
}
...
- (void)rewardedVideoAdVideoDidLoad:(BURewardedVideoAd *)rewardedVideoAd {
    ...
    BUD_Log(@"rewardedVideoAdVideoDidLoad::%s", __func__);
}
...
- (void)rewardedVideoAd:(BURewardedVideoAd *)rewardedVideoAd didFailWithError:(NSError *)error {
    ...
    BUD_Log(@"rewardedVideoAd::%s", __func__);
}

- (void)rewardedVideoAdWillVisible:(BURewardedVideoAd *)rewardedVideoAd {
    [self.delegate willPresentFullScreenView];
    [self.delegate reportImpression];
    BUD_Log(@"rewardedVideoAdWillVisible::%s", __func__);
}

- (void)rewardedVideoAdDidVisible:(BURewardedVideoAd *)rewardedVideoAd{
    [self.delegate didStartVideo];
    BUD_Log(@"rewardedVideoAdDidVisible:::%s", __func__);
}

- (void)rewardedVideoAdWillClose:(BURewardedVideoAd *)rewardedVideoAd{
    [self.delegate willDismissFullScreenView];
    BUD_Log(@"rewardedVideoAdWillClose::%s", __func__);
}

- (void)rewardedVideoAdDidClose:(BURewardedVideoAd *)rewardedVideoAd {
    [self.delegate didDismissFullScreenView];
    BUD_Log(@"rewardedVideoAdDidClose::%s", __func__);
}
...
- (void)rewardedVideoAdServerRewardDidSucceed:(BURewardedVideoAd *)rewardedVideoAd verify:(BOOL)verify {
    ...
    BUD_Log(@"rewardedVideoAdServerRewardDidSucceed::%s", __func__);
}
